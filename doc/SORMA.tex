...
\noindent {\centering Darren E. Holland$^1$, James E. Bevins$^2$, Larry W. Burggraf$^2$, Buckley E. O'Day$^2$}
\vspace{0.1in}

\symbolfootnote[1]{\centering\ Department of Mechanical Engineering\\
	Cedarville University, Cedarville, OH 45502 USA\\}
\symbolfootnote[2]{\centering\ Department of Engineering Physics\\
...
superior identification characteristics than the original design.}
...
Lastly, the Hadamard approach used for rotating encoding masks was modified and applied.
...
\begin{figure}[ht!]
\centering
\includegraphics[width={1.5in}]{../figs/EVGeo.pdf}
\caption{RSM geometry created by the eigenvector approach.}
\label{fig:EVGeo}
\end{figure}

\begin{figure}[ht!]
\includegraphics[width={1.5in}]{../figs/BiGeo.pdf}
\centering
...
\begin{figure}[ht!]
\centering
\includegraphics[width={1.5in}]{../figs/HadGeo.pdf}
...
$c$ was determined to be 0.999 from the design surface minimization.  
