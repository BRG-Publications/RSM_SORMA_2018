...
% This paragraph in general has me a bit confused.  I added the "detector-mask-source" geometry as I think this is what was being referred to.   
...
%I am not sure how the first qualificiation fits into the preceeding statements.  Is the point that in contrast to Fitzgerald's design assumptions?
...
% Is it the increase in scatters that leads to a higher number of counts or the reduction in photon energy that leads to a higher interaction probability?  As written, I read it as scatters are preferentially towards the detector, or that there is some multiplication happening, both of which aren't true.
...
Unfortunately, there is a corresponding limit to the spatial resolution.  
% Solid angle wrt to what?  It seems like this is stating that neighboring rotation angles can have a high degree of correlation depending on the angle discretization.  This limits the directional resoulution of any design.  Is that correct?
...
% I am missing something on the transition from the previous sentence to the next that could use some clarification.
