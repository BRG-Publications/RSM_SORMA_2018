...
% maybe also worth noting  why the switch to MCNP was made
% Reworded.  Comment addressed?
...
% Replication removed except in proof
...
% Does this satisfy your comment?  For brevity only, the best results are discussed - the other systems produced higher MAC numbers
...
% I do not understand the n m in the denominator.
% Reworded to express that n and m cause epsilon to be the average efficiency over all the initial positions.
\begin{equation}
...
% Which part?  c?  We know the vectors must be linearly dependent.  However, we can control how much of the other vectors we add by changing c.
...
% Yes, I do have some preliminary Compton study results from this summer that it would be good to get your thoughts on as we look at neutrons.  I'll send them to you later this weekend.
% Update: Sent...
\begin{table}[ht]
...
% Changes made, Comment addressed?
