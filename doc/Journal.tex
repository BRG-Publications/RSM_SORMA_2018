...
\begin{figure}[ht!]
\includegraphics[width={3.0in}]{P2AtIso.pdf}
\centering
...
\begin{figure}[ht!]
\includegraphics[width={3.0in}]{MassSys.pdf}
\centering
...
\begin{figure}[ht!]
\includegraphics[width={3.0in}]{Eigprob32bitCouple2W1.pdf}
\centering
...
\begin{figure}[ht!]
\centering
\includegraphics[width={2.0in}]{EVGeo.pdf}
\caption{RSM geometry created by the eigenvector approach}
\label{fig:EVGeo}
\end{figure}
\begin{figure}[ht!]
\includegraphics[width={2.0in}]{BiGeo.pdf}
\centering
...
\begin{figure}[ht!]
\centering
\includegraphics[width={2.0in}]{HadGeo.pdf}
...
\begin{figure}[ht!]
\includegraphics[width={3.0in}]{RSMMAC.pdf}
\centering
...
\begin{figure}[ht!]
\includegraphics[width={3.0in}]{TermPlot.pdf}
\centering
